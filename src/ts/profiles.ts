 ...
 *
 * Profile data is immutable and carries no user-visible English of its own;
 * display names are autonyms supplied by the language communities.
 */

import type { LanguageProfile } from './core';

/** Mandinka (Latin script, Gambia). */
...
/** Fula / Fulfulde (Latin script, Senegal). */
...
/** Profiles supported by the first release. */
