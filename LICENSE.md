# STARISIAN TECHNOLOGIES PROPRIETARY SOURCE CODE LICENSE

Copyright © 2026 Starisian Technologies (Max Barrett). All Rights Reserved.
...
This repository and all contained files—including but not limited to source code, scripts, linguistic datasets, AI training materials, marketing systems, and project management documentation (collectively, the "Software")—are the exclusive property of Starisian Technologies.

### 2. LIMITED PERMISSIONS & GITHUB FORKING

This Software is **NOT** open source. By accessing this public repository, you are granted only the following rights:

- The right to **view** the source code on GitHub.com.
- The right to **"fork"** the repository through the GitHub Service, solely as permitted by the [GitHub Terms of Service](https://docs.github.com/en/site-policy/github-terms/github-terms-of-service).

Forking through the GitHub platform does not grant any right to use, execute, modify, sublicense, or distribute the Software beyond the limitations stated herein.

### 3. PROHIBITED ACTIONS

Except for the limited forking right described above, all other rights are reserved. You are **STRICTLY PROHIBITED** from:

- **COMMERCIAL USE:** Running, executing, or using the Software for any commercial, SaaS, or revenue-generating purpose.
- **MODIFICATION:** Creating derivative works or altering the code for use in other projects.
- **EXTERNAL DISTRIBUTION:** Distributing, sublicensing, or mirroring the code outside of the GitHub platform.
- **AI TRAINING:** Utilizing the linguistic datasets or logic to train, fine-tune, or validate any third-party AI models or databases.
...
The Software is provided "AS IS", without warranty of any kind. In no event shall Starisian Technologies or Max Barrett be liable for any claim, damages, or other liability arising from the viewing or use of this Software.

### 6. GOVERNING LAW AND JURISDICTION

This agreement shall be governed by the laws of the State of California. Any legal proceedings shall take place exclusively in the state or federal courts located in Los Angeles, California.
...
This repository is made available strictly for use by:
